...
namespace app\modules\procesarguiastotal\controllers;
...
use app\modules\procesarguiastotal\query\Consultas;
...
class DefaultController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        try {
            ...
            $command = Yii::$app->db->createCommand('call selectNumeroSolicitudT()');
    ...
    public function actionListarPendGuias()
    {
        ...
        $data = "";
        foreach ($result as $d) {
            $data .= '<option value="' . $d['nm_solicitud'] . '">' . $d['nm_solicitud'] . '</option>';
        }
    ...
    public function actionLista()
    {
        ...
        $total_registro = 0;
        try {
            $command = Yii::$app->db->createCommand('call listadoGuiasPendienteTotal(:row,:length,:buscar,@total)');
        ...
        foreach ($result as $k => $row) {
            ...
            $botones = '
                             <a class="btn btn-icon btn-light-success btn-sm mr-2" href="procesarguiastotal/default/editar/' . $row["id_guia_remision"] . '"><i class="flaticon-edit"></i></a>';
