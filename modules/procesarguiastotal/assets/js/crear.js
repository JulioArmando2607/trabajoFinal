...
$(document).ready(function () {
 $("#ultimaguia").html(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguias/default/ultima-guia',
 ...
 $("#solicitud_pendiente_guia").html(function () {
    ...
    $("#via").change(function () {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguiastotal/default/buscar-tipo-v',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_via: $(this).val()
            },
    ...
    $("#numero").blur(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguiastotal/default/buscar-guia',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                numero: numero,
                serie: serie
        ...
        $("#frm-guia-remision").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: APP_URL + '/procesarguiastotal/default/create',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: {
                        serie: serie,
                        numero: numero,
