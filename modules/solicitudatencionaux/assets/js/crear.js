...
function listaAgente() {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: APP_URL + '/solicitudatencionaux/default/listar-agente',
...
function listaEntidad() {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: APP_URL + '/solicitudatencionaux/default/listar-entidad',
        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
        data: {
            // id_entidad: $("#entidades").val()
        },
...
$(document).ready(function () {
    ...
    $("#numero").blur(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/solicitudatencionaux/default/buscar-guia',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                numero: numero,
                serie: serie
        ...
        $("#frm-guia-remision").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: APP_URL + '/solicitudatencionaux/default/create',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: {
                        serie: serie,
                        numero: numero,
...
function  funcionAgregarAgente() {
    ...
    $.post(APP_URL + '/solicitudatencionaux/default/reg-agente/', {}, function (resp) {
        bootbox.dialog({
...
function funcionAgregarDestinatario() {
    ...
    $.post(APP_URL + '/solicitudatencionaux/default/reg-entidad', {}, function (resp) {
        bootbox.dialog({
        ...
        $("#numero_documento_entidad").blur(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: APP_URL + '/solicitudatencionaux/default/buscar-numero-doc',
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                data: {
                    numero: numero,
                ...
                $("#frm-guia-venta-entidad").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/solicitudatencionaux/default/crear-entidad',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            data: {
...
function funcionAgregarTranportista() {
    ...
    $.post(APP_URL + '/solicitudatencionaux/default/reg-transportista/', {}, function (resp) {
        bootbox.dialog({
            title: "<h2><strong>Registro Agente</strong></h2>",
            message: resp.plantilla,
            size: 'large',
        ...
        $("#numero_documento").blur(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: APP_URL + '/solicitudatencionaux/default/buscar-numero-doc-trs',
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                data: {
                    numero: numero,
                ...
                $("#form-transportista-reg").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/solicitudatencionaux/default/crear-transportista',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            data: {
                            ...
                            success: function (response) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: 'json',
                                    url: APP_URL + '/solicitudatencionaux/default/buscar-transportista',
                                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                                    data: {
