    ...
    <form class="form" id="frm-guia-remision">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select disabled=""  class="form-control select2"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" id="direccion_partida" name="direccion_partida">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <button type="button" class="btn btn-icon btn-primary btn-sm mt-7" id="destinatario-nuevo" onclick="funcionAgregarDestinatario()">
                            <i class="flaticon-add-circular-button"></i>
                        </button>
                    </div>  
                </div>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="transportista" name="transportista">
                            ...
                            <?php foreach ($transportista as $v): ?>
                                <option value="<?= $v->id_transportista ?>" <?= $guia->transportista == $v->id_transportista ? 'selected' : '' ?>><?= $v->razon_social ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <button type="button" class="btn btn-icon btn-primary btn-sm mt-7" id="tranportistanuevo-nuevo" onclick="funcionAgregarTranportista()">
                            <i class="flaticon-add-circular-button"></i>
                        </button>
                    </div>  
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input   type="number" class="form-control form-control-sm" id="pesovol" step=".01" name="pesovol" value="0"/>
                    </div>        
                </div>
                <!-- <div class="col-md-2">
                    <div class="form-group">
                        <label>Volumen(m3)</label>
                        <input type="number" class="form-control form-control-sm" id="volumen" name="volumen"/>
                    </div>        
                </div>--->
                <div class="col-md-1">
                    <div class="form-group">
                        <button type="button" class="btn btn-icon btn-primary btn-sm mt-7" id="agregar-detalle">
                            <i class="flaticon-add-circular-button"></i>
                        </button>
                    </div>        
                </div>
        ...
        <div class="card-footer text-right">
            ...
            <a href="<?= Yii::$app->urlManager->createUrl("solicitudatencionaux"); ?>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
    <!--end::Form-->
</div>
