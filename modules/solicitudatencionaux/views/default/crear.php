            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text"  style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control form-control-sm" id="transportista" name="transportista"/>
                    </div>        
                </div>
                <div class="col-md-2">
                    <div class="form-group">
