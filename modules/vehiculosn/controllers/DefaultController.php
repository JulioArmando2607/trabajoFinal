...
namespace app\modules\vehiculosn\controllers;
...
class DefaultController extends Controller
{
    ...
    public function actionDelete()
    {
        if (Yii::$app->request->post()) {
            ...
            try {
                //Traemos los datos mediante el id
                $vehiculos = Vehiculosn::findOne($post['id_vehiculo']);
    ...
    public function actionLista()
    {
        ...
        try {
            $command = Yii::$app->db->createCommand('call listadoVehiculosn(:row,:length,:buscar)');
