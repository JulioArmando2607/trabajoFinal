...
$(document).ready(function () {
    ...
    if ($("#remitente").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguias/default/buscar-direccion',
    ...
    if ($("#id_guia").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguias/default/detalle-guia',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_guia: $("#id_guia").val()
            },
    ...
    if ($("#id_guia").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/procesarguias/default/guia-cliente',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_guia: $("#id_guia").val()
            },
        ...
        $("#frm-guia-remision").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: APP_URL + '/procesarguias/default/update',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: {
                        id_guia: $("#id_guia").val(),
                    ...
                    success: function (response) {
                        window.location.href = APP_URL + '/procesarguias';
                    }
                });
            }
        });
