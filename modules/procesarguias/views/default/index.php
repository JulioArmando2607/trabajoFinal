...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
      ...
      <!--  <div class="col-md-3">
        ...
        <div class="card-toolbar">
            ...
            <a hidden="" onclick="funcionProcesarPend()" class="btn btn-primary">
    ...
    <div class="card-body">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="input-icon">
                        <input type="text" class="form-control" placeholder="Buscar..." id="tabla-procesarguias-buscar" />
                        <span>
        ...
        <!--end: Search Form-->
        <!--begin: Datatable-->
        <div class="datatable datatable-bordered datatable-head-custom" id="tabla-procesarguias"></div>
        <!--end: Datatable-->
    </div>
</div>
<!--end::Card-->