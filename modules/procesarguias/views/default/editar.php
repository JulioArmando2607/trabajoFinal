...
use app\modules\procesarguias\bundles\ProcesarGuiasAsset;

$bundle = ProcesarGuiasAsset::register($this);
?>
          ...
          <!--  <div class="row">
               ...
               <div class="col-md-1">
                 ...
                 <div class="col-md-2">
                    <div class="form-group">
                        <label>PESO VOL</label>
                        <input   type="number" class="form-control form-control-sm" id="pesovol" name="pesovol"/>
                    </div>
                </div>

                <div class="col-md-1">
                    <div class="form-group">
                        <button type="button" class="btn btn-icon btn-primary btn-sm mt-7" id="agregar-detalle-edit">
                            <i class="flaticon-add-circular-button"></i>
                        </button>
                    </div>
                </div>
...
-->
        ...
        <div class="card-footer text-right">
            ...
            <a href="<?= Yii::$app->urlManager->createUrl("procesarguias"); ?>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
    <!--end::Form-->
</div>
