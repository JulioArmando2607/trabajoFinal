...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form class="form" id="frm-guia-remision">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">                       
                        ...
                        <select disabled="" class="form-control select2" id="direccion_partida" name="direccion_partida"></select>
            ...
            <div hidden="" class="alert alert-custom alert-primary pt-1 pb-1 pl-1" >
