...
use app\modules\transportista\bundles\TransportistaAsset;

$bundle = TransportistaAsset::register($this);
?>
<form id="form-transportista">
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control select2" id="ubigeos" name="ubigeos" style="width: 100%;">
                ...
                <?php foreach ($ubigeos as $v): ?>
                    <option value="<?= $v->id_ubigeo ?>" <?= $entidad->ubigeo == $v->id_ubigeo ? 'selected' : '' ?>>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control" placeholder="Ingrese Urbanizacion" name="urbanizacion" id="urbanizacion" value="<?= $entidad->urbanizacion ?>" />
        </div>

        <div class="form-group col-md-6">
            <label>Referencias<span class="text-danger">*</span></label>
            <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control" placeholder="Ingrese Referencias" name="referencias" id="referencias" value="<?= $entidad->referencia ?>"/>
        </div> 
    </div>
