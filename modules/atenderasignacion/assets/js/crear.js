var detalle_guia = [];
var detalle_guia_rc = [];
var idArchivoAsignar=0;
function listaAgente() {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: APP_URL + '/atenderasignacion/default/listar-agente',
...
function listaEntidad() {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: APP_URL + '/atenderasignacion/default/listar-entidad',
        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
        data: {
            // id_entidad: $("#entidades").val()
        },
...
$(document).ready(function () {
    ...
    $("#direccion_destino").select2({
        placeholder: "Seleccioné Direccion Destino"
    });
    ...
    $("#destinatarioa").change(function () {
        $.ajax({
            ...
            success: function (response) {
                $("#direccion_destino").html(response);
            }
        });
    });

    if ($("#destinatarioa").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/atenderasignacion/default/buscar-direccion',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_entidad: $("#destinatarioa").val()
            },
            success: function (response) {
                $("#direccion_destino").html(response);
                var id_direccion_destino = $("#id_direccion_destino").val();
                $("#direccion_destino option[value='" + id_direccion_destino + "']").attr("selected", true);
            }
        });
    }
    ...
    $("#via").change(function () {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/atenderasignacion/default/buscar-tipo-v',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_via: $(this).val()
            },
    ...
    /*  $("#numero").blur(function () {
          ...
          $.ajax({
              type: "POST",
              dataType: 'json',
              url: APP_URL + '/atenderasignacion/default/buscar-guia',
              contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
              data: {
                  numero: numero,
                  serie: serie
    ...
    $("#btn-guardar").click(function () {
        $("#frm-guia-remision").validate({
            ...
            submitHandler: function () {
                ...
                var destinatario = $("#destinatarioa").val();
                var direccion_llegada = $("#direccion_destino").val();
             ...
             //   var transportista = $("#transportista").val();
                ...
                var id_pedido_cliente = $("#id_pedido_cliente").val();
                var idArchv = idArchivoAsignar;

                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: APP_URL + '/atenderasignacion/default/create',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: {
                        serie: serie,
                        numero: numero,
                    ...
                    success: function (response) {
                        window.location.href = APP_URL + '/atenderasignacion';
...
function  funcionAgregarAgente() {
    ...
    $.post(APP_URL + '/atenderasignacion/default/reg-agente/', {}, function (resp) {
        bootbox.dialog({
                ...
                $("#form-agente-reg").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/atenderasignacion/default/create-agente',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            data: {
                            ...
                            success: function (response) {
                                ...
                                if (response) {
                                    $.ajax({
                                        type: "POST",
                                        dataType: 'json',
                                        url: APP_URL + '/atenderasignacion/default/buscar-agente',
                                        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                                        data: {
                                            id_agente: response
                                            // id_entidad: $("#entidades").val()
...
function  funcionCargarED(response) {
    ...
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: APP_URL + '/atenderasignacion/default/buscar-entidad',
        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
        data: {
            id_entidad: response
        },
...
function funcionAgregarDestinatario() {
    ...
    $.post(APP_URL + '/atenderasignacion/default/reg-entidad', {}, function (resp) {
        bootbox.dialog({
        ...
        $("#numero_documento_entidad").blur(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: APP_URL + '/atenderasignacion/default/buscar-numero-doc',
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                data: {
                    numero: numero,
                ...
                $("#frm-guia-venta-entidad").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/atenderasignacion/default/crear-entidad',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            data: {
...
function funcionAgregarTranportista() {
    ...
    $.post(APP_URL + '/atenderasignacion/default/reg-transportista/', {}, function (resp) {
        bootbox.dialog({
            title: "<h2><strong>Registro Agente</strong></h2>",
            message: resp.plantilla,
            size: 'large',
        ...
        $("#numero_documento").blur(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: APP_URL + '/atenderasignacion/default/buscar-numero-doc-trs',
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                data: {
                    numero: numero,
                ...
                $("#form-transportista-reg").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/atenderasignacion/default/crear-transportista',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            data: {
                            ...
                            success: function (response) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: 'json',
                                    url: APP_URL + '/atenderasignacion/default/buscar-transportista',
                                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                                    data: {
...
$("#image").change(function () {
   ...
   /* if (id) {
    ...
    $.ajax({
        url: APP_URL + '/atenderasignacion/default/subir-imagen',
        type: 'post',
        data: formData,
        cache: false,
        contentType: false,
