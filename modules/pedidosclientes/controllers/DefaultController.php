...
namespace app\modules\pedidosclientes\controllers;
...
use app\modules\pedidosclientes\query\Consultas;
...
/**
 * Default controller for the `pedidosclientes` module
 */
    ...
    public function actionCreate()
    {
        ...
        if (Yii::$app->request->post()) {
            ...
            try {
                ...
                $pedidosClientes->id_cliente = $post["entidades"];
...
//                $pedidosClientes->id_estado = Utils::PENDIENTE;
    ...
    public function actionLista()
    {
        ...
        $total_registro = 0;
        try {
            $command = Yii::$app->db->createCommand('call listadoPedido(:row,:length,:buscar,:usuario_session,@total)');
        ...
        foreach ($result as $k => $row) {
            ...
            $botones = ' <a  class="btn btn-icon btn-light-primary mr-2" href="pedidosclientes/default/visualizar/' . $row["id_pedido_cliente"] . '"><i class="flaticon-eye"></i></a>';
