<form id="form-conductores">
      <div class="form-group">
            ...
            <select class="form-control select2" id="personas" name="personas" style="width: 100%;">
                ...
                <?php foreach ($personas as $v): ?>
                    <option value="<?= $v->id_persona ?>"><?= $v->dni . ' - ' . $v->nombres . ' - ' . $v->apellido_paterno ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  class="form-control" placeholder="Ingrese Licencia" name="licencia" id="licencia"/>
    </div>
