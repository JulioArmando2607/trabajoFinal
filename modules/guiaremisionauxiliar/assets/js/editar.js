...
$(document).ready(function () {
    ...
    if ($("#id_guia").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/guiaremisionauxiliar/default/detalle-guia',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_guia: $("#id_guia").val()
            },
    ...
    if ($("#id_guia").val() != null) {
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: APP_URL + '/guiaremisionauxiliar/default/guia-cliente',
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            data: {
                id_guia: $("#id_guia").val()
            },
        ...
        $("#frm-guia-remision").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: APP_URL + '/guiaremisionauxiliar/default/update',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: {
                        id_guia: $("#id_guia").val(),
                        serie: serie,
