            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Serie</label>
                        <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control form-control-sm" id="serie" name="serie" value="<?= $guia->serie ?>"/>
                    </div>        
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Número</label>
                        <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control form-control-sm" id="numero" name="numero" value="<?= $guia->numero_guia ?>"/>
                    </div>        
                </div>
                <div class="col-md-2">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        ...
                        <input type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase();" class="form-control form-control-sm" id="grs" name="grs"/>
                    </div>        
                </div>
                <div class="col-md-1">
                    <div class="form-group">
            ...
            <table disabled="" class="table">
                <thead>
                    <tr>
                        ...
                        <th disabled=""  scope="col"></th>
                    </tr>
                </thead>
                <tbody disabled=""  id="tabla-detalle-guia">
