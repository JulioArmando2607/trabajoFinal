...
<form id="form-editargcliente">
    ...
    <input id="id_archivo_cli" class="form-control form-control-sm" disabled name="id_archivo_cli" type="hidden" value="<?= $guiaRC->id_archivo ?>" />

    <input id="id_guia_remision" class="form-control form-control-sm" disabled name="id_guia_remision" type="hidden" value="<?= $guiaRC->id_guia_remision ?>" />
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <div class="row"><label class="col-sm-2 col-form-label">Estado Mercadería</label>
                    ...
                    <div class="col-sm-3"><input class="form-control " name="fecha_hora_entrega" id="fecha_hora_entrega" type="date" value="<?= empty($guiaRC->fecha_hora_entrega) ? date("Y-m-d") : $guiaRC->fecha_hora_entrega ?>"></div>
                ...
                <div class="row"><label class="col-sm-2 col-form-label">Estado Cargo</label>
                    ...
                    <div class="col-sm-3"><input class="form-control ng-valid ng-dirty ng-touched" name="fecha_cargo" id="fecha_cargo" type="date" value="<?= empty($guiaRC->fecha_cargo) ? '': $guiaRC->fecha_cargo ?>"></div>
                </div>
                ...
                <div class="row"><label class="col-sm-2 col-form-label">Observación</label>
                    <div class="col-sm-10"><input class="form-control ng-valid ng-touched ng-dirty" name="obsevacion" type="text" id="obsevacion" value="<?= $guiaRC->observacion ?>"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-10">
            <div class="card" style="width: 10rem;">
                ...
                <div class="form-group">
                    ...
                    <img class="card-img-top" id="segcl" src="<?= $seguimientorc["nombre_ruta"] ?>">
        ...
        <div class="col-12">
            <div class="form-row mt-50 mb-50">
                ...
                <div class="form-check">
                    <a class="btn btn-icon btn-light-primary btn-sm mr-2" target="_blank"   >
                        <input type="checkbox" id="checkaplicartodos"  name="checkaplicartodos" >
                    </a>

                    <label class="form-check-label" for="checkaplicartodos"> Aplicar a todos </label>
