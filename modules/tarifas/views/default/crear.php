...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-body">
        <div class="alert alert-custom alert-primary pt-1 pb-1 pl-1">
            <div class="alert-text font-weight-bold">SELECCIONA ENTIDAD A TARIFAR</div>
        </div>
            ...
            <div class="col-md-9">
                <div class="form-group">
                    <select class="form-control select2" id="entidades" name="entidades">
                        ...
                        <?php foreach ($entidades as $c) : ?>
                            <option value="<?= $c->id_entidad ?>"><?= $c->razon_social ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div hidden id="divview">
                <div class="col-md-6" >
                    <div class="form-group">
        ...
        <div class="example" id="divtabs">
            ...
            <div class="example-preview">
                ...
                <div class="tab-content mt-5" id="myTabContent">
                    <div class="tab-pane fade active show" id="aereo" role="tabpanel" aria-labelledby="aereo-tab">
                        ...
                        <div class="example">
                                        ...
                                        <div >
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    ...
                                                    <input class="form-control" name="costo" id="costo" type="number" value="50" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="igv" id="igv" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="igv_total_a" id="igv_total_a" type="number" >
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="tarifarefaereo" role="tabpanel" aria-labelledby="tarifarefaereo-tab">
                                        <div >
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">COSTO</label>
                                                    <input class="form-control" name="costo" id="costo_t_a_ref" type="number" value="65" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="igv" id="igv_t_a_ref" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="total_t_a_ref" id="total_t_a_ref" type="number" >
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="cargadificilmanejoaereo" role="tabpanel" aria-labelledby="cargadificilmanejoaereo-tab">
                                        <div >
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">COSTO</label>
                                                    <input class="form-control" name="costo_t_a_pel" id="costo_t_a_pel" type="number" value="98" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="igv_t_a_pel" id="igv_t_a_pel" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="total_t_a_pel" id="total_t_a_pel" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">Peso base </label>
                            ...
                            <!--    <div class="card-footer text-right">
                                     <button type="submit" class="btn btn-primary mr-2" onclick="guardartarifaAerea()">Guardar</button>
                                    ...
                                    <div class="tab-pane fade active show" id="tarifageneralterrestre" role="tabpanel" aria-labelledby="tarifageneralterrestre-tab">
                                        <div >
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">COSTO</label>
                                                    <input class="form-control" name="tarifa_m_t_costo" id="tarifa_m_t_costo" type="number" value="40" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="tarifa_m_t_igv" id="tarifa_m_t_igv" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="tarifa_m_t_total" id="tarifa_m_t_total" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">Peso base </label>
                                    ...
                                    <div class="tab-pane fade" id="tarifarefterrestre" role="tabpanel" aria-labelledby="tarifarefterrestre-tab">
                                        ...
                                        <div >
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">COSTO</label>
                                                    <input class="form-control" name="costo_t_g_ref" id="costo_t_g_ref" type="number" value="55" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="igv_t_g_ref" id="igv_t_g_ref" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="total_t_g_ref" id="total_t_g_ref" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">Peso base </label>
                                    ...
                                    <div class="tab-pane fade" id="cargadificilmanejterrestre" role="tabpanel" aria-labelledby="cargadificilmanejterrestre-tab">
                                        ...
                                        <div>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">COSTO</label>
                                                    <input class="form-control" name="costo_t_c_p_d" id="costo_t_c_p_d" type="number" value="45" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">IGV</label>
                                                    <input class="form-control" name="igv_t_c_p_d" id="igv_t_c_p_d" type="number" >
                                                </div>
                                                <div class="form-group input-group-sm col-md-3">
                                                    <label class="font-small">TOTAL</label>

                                                    <input class="form-control" name="total_t_c_p_d" id="total_t_c_p_d" type="number" >
                                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2">
                                    <div class="input-icon">
                                        ...
                                        <button onclick="funcionAgregarProTerrestre()" class="btn btn-primary">
                                            <i class="text-white flaticon-graphic-1"></i>
                                            Registrar Provincia
                                        </button>
                                    </div>
                    ...
                    <div class="card-footer text-right">
                        <button type="submit" class="btn btn-primary mr-2" onclick="guardartarifa()">Guardar</button>
                        <a href="<?= Yii::$app->urlManager->createUrl("tarifas"); ?>" class="btn btn-secondary">Cancelar</a>
                    </div>
                </div>
