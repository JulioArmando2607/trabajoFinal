...
<form id="frm-seguimiento">
    ...
    <div class="card card-custom gutter-b example example-compact">
        <input id="id_guia_remision" class="form-control form-control-sm" disabled name="id_guia_remision" type="hidden" value="<?= $guia_remision->id_guia_remision ?>" />
                                        ...
                                        <div class="col-sm-10">
                                            <div class="card" style="width:10rem;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" style="display:none;" class="form-control-file" name="<?= $seguimiento["nombre_archivo"] ?>" id="image" data-buttonText="Your label here.">
                                                </div>
        ...
        <div class="card-footer text-right">
            <button type="submit" class="btn btn-primary mr-2" id="btn-guardar" onclick="mostrarTablaTemporalRC()">Guardar</button>
