...
<div class="card card-custom gutter-b example example-compact">
    ...
    <input type="hidden" id="id_cliente_v" value="<?=empty($pedidosCliente["id_cliente"]) ? '' : $pedidosCliente["id_cliente"] ?>">
 
    <form class="form" id="frm-pedidosclientes">
        <div class="card-body">
            <div class="alert alert-custom alert-primary pt-1 pb-1 pl-1">
                <div class="alert-text font-weight-bold">Pedido</div>
            </div>
         ...
         <div id="id_div_not" class="row"> 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" disabled class="form-control form-control-sm" id="notificacion_" name="notificacion_" value="<?=  empty($pedidosCliente["notificacion"]) ? '' : $pedidosCliente["notificacion"] ?>"/>
                    </div>     
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" disabled class="form-control form-control-sm" id="notificacion_descarga" name="notificacion_descarga" value="<?=  empty($pedidosCliente["notificacion_descarga"]) ? '' :  $pedidosCliente["notificacion_descarga"] ?>"/>
                    </div>        
                </div>
