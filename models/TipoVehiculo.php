 ...
 * @property float|null $kilometraje_max
...
class TipoVehiculo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['descripcion', 'flg_estado', 'id_usuario_reg', 'fecha_reg', 'ipmaq_reg'], 'required'],
            [['kilometraje_max'], 'number'],
            [['flg_estado', 'id_usuario_reg', 'id_usuario_act', 'id_usuario_del'], 'integer'],
            [['fecha_reg', 'fecha_act', 'fecha_del'], 'safe'],
            [['descripcion', 'ipmaq_reg', 'ipmaq_act', 'ipmaq_del'], 'string', 'max' => 20],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kilometraje_max' => 'Kilometraje Max',
