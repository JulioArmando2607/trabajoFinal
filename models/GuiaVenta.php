...
class GuiaVenta extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['numero_guia', 'id_forma_pago', 'id_tipo_comprobante', 'id_conductor', 'id_vehiculo', 'id_tipo_documento_remitente', 'id_estado', 'id_archivo', 'id_agente', 'id_usuario_reg', 'id_usuario_act', 'id_usuario_del', 'id_entidad_', 'id_estados_venta', 'flg_factura'], 'integer'],
            [['fecha', 'fecha_entrega', 'fecha_reg', 'fecha_act', 'fecha_del'], 'safe'],
            [['serie', 'ipmaq_reg', 'ipmaq_act', 'ipmaq_del'], 'string', 'max' => 20],
            [['factura_boleta', 'guia_cliente'], 'string', 'max' => 200],
            [['comentario', 'observacion'], 'string', 'max' => 255],
        ];
    }
